...
function generateMultiplatformEmbed() {
	...
	for (const platformKey of platformDirs) {
		...
		console.log(`🖥️  Processing ${platformKey}...`);
		...
		if (Object.keys(platformModules).length > 0) {
			...
			console.log(`   ⚠️  No valid binaries found`);
		}
	...
	if (Object.keys(platforms).length === 0) {
		console.error("❌ No platforms with valid binaries found!");
		process.exit(1);
	}
...
`;
	...
	console.log(`🖥️  Platforms: ${platformKeys.join(", ")}`);
	console.log("=".repeat(50));
	console.log("");
	console.log("✅ Multi-platform embedded modules generated successfully!");
}
...
try {
	...
	console.error("❌ Failed to generate embedded modules:", error);
	process.exit(1);
}
